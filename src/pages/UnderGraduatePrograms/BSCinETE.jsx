...
const BSCinETE = () => {
    ...
    // Data extracted from the B.Sc in ETE screenshot
    const semesterData = [
        {
            title: "1st Year - 1st Semester",
            courses: [
                { code: "MATH 0541-1101", name: "Mathematics I", credit: "6" },
            ]
        },
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
                    ...
                    <div className="w-full">
                        ...
                        <div className="border border-gray-200 rounded-md bg-white">
                                        ...
                                        {isOpen && (
                                            <div className="p-0 md:p-4 bg-white animate-fadeIn overflow-x-auto">
                                                {sem.courses.length > 0 ? (
                                                    <table className="w-full text-sm text-left border border-gray-200 min-w-100 md:min-w-full">
                                                        <thead>
                                                            <tr className="bg-gray-50">
                                                                <th className="border border-gray-200 px-3 py-2 font-semibold text-gray-700 w-[30%]">Course Code</th>
                                                                <th className="border border-gray-200 px-3 py-2 font-semibold text-gray-700 w-[50%]">Course Name</th>
                            ...
                            {/* Summary Footer (Specific to ETE screenshot) */}
