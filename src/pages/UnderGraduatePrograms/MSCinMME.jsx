...
const MSCinMME = () => {
    // Default open index 1 (1st Year - 2nd Semester) to match screenshot
    ...
    // Data extracted from the MSc MME Department screenshot
    const semesterData = [
        { title: "1st Year - 1st Semester", courses: [] },
        {
            title: "1st Year - 2nd Semester",
            courses: [
                { code: "MMSE5211", name: "Visualization Methods", credit: "3" },
                { code: "MMSE5212", name: "Process Automation", credit: "3" },
                { code: "MMSE5213", name: "Foundations of Numerical Simulation", credit: "2" },
                { code: "MMSE5214", name: "Modern Manufacturing Methods", credit: "3" },
                { code: "MMSE5215", name: "Optimization of the Production Process", credit: "3" },
                { code: "MMSE5216", name: "Quality management", credit: "2" },
                { code: "MMSE5217", name: "Mechatronic Project", credit: "6" },
                { code: "MMSE5218", name: "Contemporary Mechatronic Subjects", credit: "2" },
                { code: "MMSE5219", name: "Professional Language Course 2 (English/German/French/Spanish/Russian)", credit: "4" },
                { code: "MMSE5220", name: "Seminar 2", credit: "2" },
                { code: "MMSE5221", name: "Anatomy and Physiology", credit: "4" },
                { code: "MMSE5222", name: "Bio-Physics", credit: "2" },
                { code: "", name: "Computer Aided Design (CAD) / Computer Aided Engineering (CAE)", credit: "6" },
            ]
        },
        { title: "2nd Year - 1st Semester", courses: [] },
        { title: "Option I", courses: [] },
        { title: "Option II", courses: [] },
        { title: "Option III", courses: [] },
        { title: "Option IV", courses: [] },
        { title: "Option V", courses: [] },
        { title: "Option VI", courses: [] },
    ];
        ...
        <div className="min-h-screen bg-white text-gray-800 font-sans pb-12">
            <div className="container mx-auto px-4 lg:px-8 max-w-7xl">
                ...
                <div className="flex justify-center my-8">
                    <div className="border border-cyan-400 rounded-full px-6 py-3 text-center shadow-sm w-full max-w-4xl">
                        <h1 className="text-lg md:text-xl lg:text-2xl text-gray-600 font-normal">
                            Master of Science in Mechatronic and Micro-Mechatronics System Engineering
                        </h1>
                    </div>
                </div>
                                        ...
                                        {isOpen && (
                                            <div className="p-0 md:p-4 bg-white animate-fadeIn overflow-x-auto">
                                                {sem.courses.length > 0 ? (
                                                    <table className="w-full text-sm text-left border border-gray-200 min-w-150 md:min-w-full">
                                                        <thead>
                                                            <tr className="bg-gray-50">
                                                                <th className="border border-gray-200 px-3 py-2 font-semibold text-gray-700 w-[20%]">Course Code</th>
                                                                <th className="border border-gray-200 px-3 py-2 font-semibold text-gray-700 w-[65%]">Course Name</th>
                                                                <th className="border border-gray-200 px-3 py-2 font-semibold text-gray-700 w-[15%]">Credit</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
