...
const BSCinPharmac = () => {
    ...
    // Data extracted from the Pharmacy Department screenshot
    const semesterData = [
        {
            title: "1st Year - 1st Semester",
            courses: [
                { code: "BPH 1101", name: "Pharmacognosy", credit: "3" },
                { code: "BPH 1102", name: "Inorganic Pharmacy- I", credit: "3" },
                { code: "BSM 1102", name: "Mathematics & Biostatistics", credit: "3" },
                { code: "SOC 101", name: "Emergence of Bangladesh", credit: "3" },
                { code: "ENG 1103", name: "Communicative English", credit: "2" },
                { code: "BPH 1103", name: "Pharmacognosy Practical", credit: "3" },
                { code: "BPH 1104", name: "Inorganic Pharmacy-I Practical", credit: "1" },
                { code: "CAP 1101", name: "Computer Applications Practical", credit: "2" },
