...
const BSCinEEE = () => {
    ...
    // Data extracted from the EEE Department screenshot
    const semesterData = [
        {
            title: "1st Year - 1st Semester",
            courses: [
                { code: "0713-1101", name: "Electrical Circuit I", credit: "3" },
                { code: "0713-1102", name: "Electrical Circuit I Lab", credit: "1.5" },
                { code: "0533-1101", name: "Physics", credit: "3" },
                { code: "0232-1101", name: "English Reading and Composition", credit: "3" },
                { code: "0541-1101", name: "Differential and Integral Calculus (EEE)", credit: "3" },
                { code: "0613-1101", name: "Computer Programming", credit: "3" },
                { code: "0613-1102", name: "Computer Programming Lab", credit: "0.75" },
                { code: "0715-1100", name: "Engineering Drawing", credit: "0.75" },
                { code: "*", name: "GED Course", credit: "3" },
                { code: "0223-1111", name: "Introduction to Ethics (EEE)", credit: "0.0" },
            ]
        },
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
                    ...
                    <div className="w-full">
                        ...
                        <div className="border border-gray-200 rounded-md bg-white">
                                        ...
                                        {isOpen && (
                                            <div className="p-0 md:p-4 bg-white animate-fadeIn overflow-x-auto">
                                                {sem.courses.length > 0 ? (
                                                    <table className="w-full text-sm text-left border border-gray-200 min-w-137.5 md:min-w-full">
                                                        <thead>
                            ...
                            {/* Summary Footer (Specific to EEE screenshot) */}
