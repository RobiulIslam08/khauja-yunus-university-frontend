...
const BSCinMME = () => {
    ...
    // Data extracted from the MME Department screenshot
    const semesterData = [
        {
            title: "1st Year - 1st Semester",
            courses: [
                { code: "MTE 0714-1101", name: "Fundamental of Mechatronics Engineering", credit: "3" },
                { code: "MTE 0714-1111", name: "Fundamental of Mechatronics Engineering Lab", credit: "0.75" },
                { code: "MTE 0541-1102", name: "Mathematical Analysis for Engineering-I", credit: "3" },
                { code: "MTE 0533-1103", name: "Physics-I", credit: "3" },
                { code: "MTE 0533-1113", name: "Physics-I Lab", credit: "0.75" },
                { code: "MTE 0531-1104", name: "Chemistry", credit: "3" },
                { code: "MTE 0531-1114", name: "Chemistry Lab", credit: "0.75" },
                { code: "MTE 0613-1105", name: "Fundamental of Computer Programming", credit: "3" },
                { code: "MTE 0613-1115", name: "Fundamental of Computer Programming Lab", credit: "0.75" },
                { code: "MTE 0713-1106", name: "Electrical Circuits", credit: "3" },
                { code: "MTE 0713-1116", name: "Electrical Circuits Lab", credit: "0.75" },
            ]
        },
                                                    ...
                                                    <table className="w-full text-sm text-left border border-gray-200 min-w-125 md:min-w-full">
                                                        <thead>
                                                            <tr className="bg-gray-50">
                                                                <th className="border border-gray-200 px-3 py-2 font-semibold text-gray-700 w-[25%]">Course Code</th>
                                                        ...
                                                        <tbody>
                                                            {sem.courses.map((course, idx) => (
                                                                <tr key={idx} className="hover:bg-gray-50">
                                                                    <td className="border border-gray-200 px-3 py-2 text-gray-600 font-medium text-xs md:text-sm whitespace-nowrap md:whitespace-normal">{course.code}</td>
