...
const BSCinMicrobiology = () => {
    ...
    // Data extracted from the Microbiology Department screenshot
    const semesterData = [
        {
            title: "1st Year - 1st Semester",
            courses: [
                { code: "MBL 101", name: "General Microbiology", credit: "4" },
                { code: "MBL-102", name: "Microbial Ecology", credit: "2" },
                { code: "MBL-103", name: "Basic Techniques in Microbiology", credit: "2" },
                { code: "MBL-104", name: "English Composition and Application (elective)", credit: "2" },
                { code: "Soc-101", name: "Emergence of Bangladesh", credit: "3" },
                { code: "ETC 111", name: "Introduction to Ethics", credit: "3" },
                { code: "MBL-105", name: "Practical", credit: "2" },
            ]
        },
                ...
                <div className="flex justify-center my-8">
                    <div className="border border-cyan-400 rounded-full px-6 py-3 text-center shadow-sm w-full max-w-4xl">
                        <h1 className="text-lg md:text-xl lg:text-2xl text-gray-600 font-normal">
                            Bachelor of Science(Hon's) in Microbiology
                        </h1>
                    </div>
                </div>
...
export default BSCinMicrobiology;