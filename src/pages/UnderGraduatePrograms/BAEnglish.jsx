...
const BAEnglish = () => {
    ...
    // Data extracted from the Department of English screenshot
    const semesterData = [
        {
            title: "1st Year - 1st Semester",
            courses: [
                { code: "ENG 111", name: "Basic English Language Skills", credit: "3" },
                { code: "ENG 112", name: "Listening and Speaking", credit: "3" },
                { code: "ENG 113", name: "Introduction to English Poetry", credit: "3" },
                { code: "ENG 114", name: "Introduction to English Literature", credit: "3" },
                { code: "ETC 111", name: "Introduction to Ethics", credit: "0" },
            ]
        },
