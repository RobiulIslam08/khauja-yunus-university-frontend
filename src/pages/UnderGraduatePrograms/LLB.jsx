...
const LLB = () => {
	...
	// Data extracted from the Department of Law screenshot
	const semesterData = [
		{
			title: "1st Year - 1st Semester",
			courses: [
				{ code: "LL.B 101", name: "English For Law - I", credit: "2" },
				{ code: "LL.B 102", name: "Introduction to Computer", credit: "2" },
				{ code: "LL.B 103", name: "Emergence of Bangladesh", credit: "2" },
				{ code: "LL.B 104", name: "Legal History and System of Bangladesh", credit: "3" },
				{ code: "LL.B 105", name: "Constitutional Law of Bangladesh – I", credit: "2" },
				{ code: "LL.B 106", name: "Jurisprudence", credit: "3" },
				{ code: "ETC III", name: "Introduction to Ethics", credit: "0" },
			]
		},
