...
const PGDinLIS = () => {
    ...
    // Data extracted from the PGD in LIS screenshot
    const semesterData = [
        {
            title: "1st Year - 1st Semester",
            courses: [
                { code: "PGD 101", name: "Introduction to Library and Information Science", credit: "4" },
                { code: "PGD 102", name: "Information Sources and Services", credit: "4" },
                { code: "PGD 103", name: "Information Resources Developments", credit: "4" },
                { code: "PGD 104", name: "Organization of Knowledge (Classification Theory)", credit: "4" },
                { code: "PGD 105", name: "Organization of Knowledge (Cataloguing Theory)", credit: "4" },
            ]
        },
