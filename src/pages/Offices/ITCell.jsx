...
const profiles = [
	{
		...
		room: "116 (Room No.)",
		imageUrl: "https://www.kyau.edu.bd/images/jakirul.png",
	},
	{
		...
		room: "116 (Room No.)",
		imageUrl: "https://www.kyau.edu.bd/images/20230208093814.png",
	},
	{
...
const ITCell = () => (
	<>
		<PageHeader title="Information Technology Office" />
		<div className="max-w-7xl mx-auto w-full">
			<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8  justify-center items-center mt-8 mb-8">
