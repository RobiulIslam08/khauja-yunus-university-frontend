...
const profileData = {
	...
	title: "Vice Chancellor (In Charge)",
	email: "vc@kyau.edu.bd",
	phone: "126 (intercom)",
	room: "210 (Room No.)",
	// Update the image path as needed, or use a public/assets path
	imageUrl: "https://www.kyau.edu.bd/public/images/20250325072122.png"
};
...
const ViceChancellor = () => (
	<>
		...
		<PageHeader title="Vice Chancellor Office" />
