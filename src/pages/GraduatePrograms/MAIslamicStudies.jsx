...
const MAIslamicStudies = () => {
    ...
    // Data extracted from the Islamic Studies screenshot
    const semesterData = [
        {
            title: "1st Year - 1st Semester",
            courses: [
                { code: "PIS 489", name: "Economics and Finance in Islam", credit: "3" },
                { code: "PIS 490", name: "Computer Literacy", credit: "3" },
                { code: "PIS 491", name: "Study of Al-Tafsir", credit: "3" },
                { code: "PIS 492", name: "Biography of Prophet (sm.)", credit: "3" },
                { code: "PIS 493", name: "Banking and Insurance in Islam", credit: "3" },
                { code: "PIS 494", name: "Modern History of the world and organization", credit: "3" },
            ]
        },
...
export default MAIslamicStudies;