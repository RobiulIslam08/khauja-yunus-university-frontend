...
const LLM = () => {
    ...
    // Data extracted from the LL.M. Department screenshot
    // Note: The screenshot shows the table headers but no courses listed for the 1st semester.
    const semesterData = [
        {
            title: "1st Year - 1st Semester",
            courses: [] // Empty in source image
        },
                                                ...
                                                <table className="w-full text-sm text-left border border-gray-200 min-w-125 md:min-w-full">
                                                    ...
                                                    <tbody>
                                                        {sem.courses.length > 0 ? (
                                                            ...
                                                            <tr>
                                                                <td colSpan="3" className="border border-gray-200 px-3 py-4 text-center text-gray-400 italic">
                                                                    No courses listed
                                                                </td>
                                                            </tr>
                                                        )}
