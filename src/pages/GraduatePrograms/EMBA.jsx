...
const EMBA = () => {
    ...
    // Data extracted from the EMBA Department screenshot
    const semesterData = [
        {
            title: "1st Year - 1st Semester",
            courses: [
                { code: "MGT 501", name: "Business Statistics", credit: "3" },
            ]
        },
        { title: "1st Year - 2nd Semester", courses: [] },
    ];

    // Tuition data is empty in the screenshot
    const tuitionData = {
        totalCredits: "-",
        duration: "-",
        totalSemesters: "-",
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
                    ...
                    <div className="w-full">
                        ...
                        <p className="text-xs text-gray-400 mt-2 text-center italic">
                            * Fee details unavailable in source image
                        </p>
                    </div>
