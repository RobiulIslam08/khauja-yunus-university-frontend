		...
		<div className="container mx-auto px-4 w-full py-6 max-w-7xl">
			...
			<div className="mb-12">
				...
				<div className="space-y-2 text-sm md:text-base leading-relaxed text-gray-600 text-justify">
					...
					<p>
					Assalamu alaikum warahmatullah, Welcome to the official website of the department of Islamic Studies. This department was established in 2014 with a goal to preach Islam and to spread Islamic education, Sufism, norms, and values in Bangladesh as well as in the whole world through its various activities, i.e. teaching, counseling, seminar-symposium, research etc.
					</p>
					<p>
						The department of Islamic Studies currently hosts several programs, e.g. B.A (Hons), M.A (Regular), Since 2016 we have introduced M.A (Preli) & M.A (Final) in Islamic Studies’ to expand Islamic education in the country.
					</p>
					<p>
This site reflects our continued efforts to the education and research in the field of Islamic ideology. On behalf of the department, I would like to welcome you and wish you success in your studies and a rewarding time at the department of Islamic Studies in Khwaja Yunus Ali University.
					</p>
				</div>
			</div>
				...
				<div className="flex flex-col md:flex-row gap-8 bg-white p-6">
					...
					<div className="w-full md:w-1/4 flex flex-col items-center">
						<div className="bg-white p-4 border border-gray-200 shadow-sm text-center w-full">
							...
							<p className="text-gray-500 text-xs mt-1">Islamic Studies</p>
						</div>
					</div>
					...
					<div className="w-full md:w-3/4">
						<div className="border-b border-gray-200 mb-4">
							<h3 className="text-lg font-bold text-gray-800 mb-2">Message from The Head of ILAMIC STUDIES Department</h3>
						</div>
...
export default IslamicStudiesHome;
