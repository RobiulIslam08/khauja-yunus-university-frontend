...
const EventSectionForBiochemistry  = () => {
	...
	const notices = [
		{
			id: 1,
			title: "Biochemistry_Class Routine Summer 2024_KYAU",
			date: "2024-07-03",
		},
		{
			id: 2,
...
export default EventSectionForBiochemistry;