...
// ডামি ডাটা (আপনি পরবর্তীতে API বা ডাটাবেজ থেকে লোড করতে পারেন)
const facultyData = [
    {
        id: 1,
        name: "Dr. Ranajit Kumar Shaha",
        designation: "Professor",
        image: "https://www.kyau.edu.bd/images/rajaul.png", // Placeholder Image
        phone: "01712782680",
                ...
                <div className="mb-10 flex justify-center">
                    <div className="border border-cyan-400 rounded-full px-8 py-3 w-full max-w-3xl text-center shadow-sm">
                        <h2 className="text-xl md:text-2xl text-gray-600 font-medium">
                            Faculty Members Department of BCBT
                        </h2>
                    </div>
                </div>
...
export default FacultyMembersPageBcbt;